package com.example.beatupisis;
...
//				LayoutParams.WRAP_CONTENT));
	...
	View.OnTouchListener test2 = new View.OnTouchListener() {  
		@Override  
	...
	View.OnClickListener test3 = new View.OnClickListener() {  
		@Override  
